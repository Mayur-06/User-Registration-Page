"""add_simple_tsvector_for_exact_numeric_matching

Revision ID: 1ebedd3300e8
Revises: 24a9b1c0d5e7
Create Date: 2026-08-24 14:14:22.802056
...
revision: str = '1ebedd3300e8'
down_revision: Union[str, Sequence[str], None] = '24a9b1c0d5e7'
...
def downgrade() -> None:
    ...
    op.execute("ALTER TABLE document_chunks DROP COLUMN IF EXISTS content_tsv_simple;")
    op.execute("ALTER TABLE user_memories DROP COLUMN IF EXISTS content_tsv_simple;")
