...
export const CallToAction = ({ onGetStarted }) => {
  return (
    <section className="py-20 px-4 md:px-10 max-w-[1440px] mx-auto">
      <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-b from-[#081322] via-[#091424] to-[#050b14] border border-[#1e293b] hover:border-[#38bdf8]/40 p-10 sm:p-16 text-center relative overflow-hidden shadow-[0_0_50px_rgba(56,189,248,0.1)] transition-all">
        {/* Ambient Top Glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-36 bg-[#38bdf8]/15 blur-[90px] pointer-events-none" />
        ...
        <div className="relative z-10 space-y-6 max-w-3xl mx-auto flex flex-col items-center">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center gap-4">
            <button
              ...
              className="px-8 py-3.5 rounded-xl bg-[#38bdf8] hover:bg-[#38bdf8]/90 text-slate-950 text-sm font-bold transition-all shadow-[0_0_25px_rgba(56,189,248,0.4)] hover:shadow-[0_0_35px_rgba(56,189,248,0.65)] hover:scale-[1.02] active:scale-[0.98] flex items-center gap-2 cursor-pointer group"
            >
          ...
          {/* Trust Micro-Pills */}
          <div className="pt-4 flex flex-wrap items-center justify-center gap-5 text-xs text-[#94a3b8] font-mono">
