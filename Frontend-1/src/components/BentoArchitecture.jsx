...
export const BentoArchitecture = () => {
  return (
    <section id="features" className="py-24 px-4 md:px-10 max-w-[1440px] mx-auto text-center scroll-mt-20">
      {/* Section Header */}
      <div className="max-w-3xl mx-auto mb-14 space-y-4">
        ...
        >
          Engineered for complex multi-modal intelligence.
        </h2>

        <p className="text-base sm:text-lg text-[#94a3b8] max-w-2xl mx-auto leading-relaxed font-sans">
          Seamlessly extract knowledge, inspect visuals, and reason across datasets with enterprise-grade grounding.
        </p>
      </div>
