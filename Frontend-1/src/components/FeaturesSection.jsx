...
import React from 'react';
import { UploadCloud, ShieldCheck, MessageSquareText, Sparkles, ArrowRight } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description:
        'Drop in a PDF, TXT, CSV, DOCX, or DOC file and start asking questions right away. Our text cleaner handles extraction, chunking, and indexing automatically—no setup required. It\'s a searchable library for your users in seconds.',
      codePreview: 'PDF · TXT · CSV · DOCX · DOC → indexed in <2s',
    },
    {
      icon: ShieldCheck,
      color: '#818cf8',
      badge: 'Per-User Isolation',
      title: 'Your Data, Isolated & Private',
      description:
        'Every user gets their own private FAISS vector index, with no cross-contamination and no accidental leaks. Built for B2B SaaS, multi-tenant environments, and anyone serious about data sovereignty.',
      codePreview: 'FAISS index scoped per user · zero cross-tenant access',
    },
    {
      icon: MessageSquareText,
      color: '#2fd9f4',
      badge: 'Calibrated Reasoning',
      title: 'Smart Context-Aware Answers',
      description:
        'The bot tells casual chat, document questions, and general knowledge apart before it answers. If it isn\'t in your docs, it says so instead of guessing—so your users can trust every response.',
      codePreview: 'chat / docs / general-knowledge → routed, then answered',
    },
  ];
  ...
  return (
    <section id="features" className="py-24 px-4 md:px-10 max-w-[1440px] mx-auto">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
        ...
        <p className="text-[#c6c5d5] text-base sm:text-lg leading-relaxed">
          From instant document ingestion to isolated, trustworthy answers, LucyChat delivers verifiable intelligence.
        </p>
      </div>
